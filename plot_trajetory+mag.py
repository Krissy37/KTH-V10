# -*- coding: utf-8 -*-
"""
Created on Thu Aug  8 11:54:34 2024
...
z_mso_km = df['orbit_pos_z'].to_numpy()[filtered_indices]

r_hel_AU = df['r_hel'].to_numpy()[filtered_indices]
di = df['di'].to_numpy()[filtered_indices]

bx_mes_nT = df['orbit_b_x'].to_numpy()[filtered_indices]
by_mes_nT = df['orbit_b_y'].to_numpy()[filtered_indices]  
bz_mes_nT = df['orbit_b_z'].to_numpy()[filtered_indices]  

dates_mes = pd.to_datetime(df['orbit_YYYYMMDDHHmm']).to_numpy()[filtered_indices]
